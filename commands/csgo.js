...
exports.run = (client, msg, args) => {
    ...
    if(msg.member.roles.find('name', 'CSGO')) {
        const role = client.guilds.get('328529653088124931').roles.find('name', 'CSGO');
...
exports.conf = {
  ...
  exports.help = {
    name: 'csgo',
    description: 'Fügt dich zu der CSGO Gruppe hinzu wenn du im UCore Clan bist!',
    usage: 'csgo ',
    example: 'csgo',
	category: 'utility'
};
