...
exports.run = (client, msg, args) => {
    ...
    if(msg.member.roles.find('name', 'Fifa')) {
        const role = client.guilds.get('328529653088124931').roles.find('name', 'Fifa');
...
exports.conf = {
  ...
  exports.help = {
    name: 'fifa',
    description: 'Fügt dich zu der Fifa18 Gruppe hinzu wenn du im UCore Clan bist!',
    usage: 'fifa ',
    example: 'fifa',
	category: 'utility'
};
